...
```
I'll add a detailed breakdown to that as a TODO, but for now, I'll just keep chugging.

Onto `advanced_search.py`. Go ahead and make a file called `advanced_search.py`.
